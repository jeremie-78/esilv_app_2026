...
class _Nutriscore extends StatelessWidget {
  ...
  String _findAssetName() {
    return switch (nutriscore) {
      ProductNutriScore.A => 'assets/drawables/nutriscore_a.png',
      ProductNutriScore.B => 'assets/drawables/nutriscore_b.png',
      ProductNutriScore.C => 'assets/drawables/nutriscore_c.png',
      ProductNutriScore.D => 'assets/drawables/nutriscore_d.png',
      ProductNutriScore.E => 'assets/drawables/nutriscore_e.png',
